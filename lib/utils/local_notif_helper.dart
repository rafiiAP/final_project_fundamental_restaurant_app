...
class NotificationHelper {
  ...
  Future<void> showNotification(
      ...
      RestaurantListModel restaurant) async {
    var channelId = "1";
    var channelName = "Restaurant";
    var channelDescription = "Notif schedule restaurant";
    ...
    var titleNews = restaurant.description.substring(0, 30);
  ...
  void configureSelectNotificationSubject() {
    selectNotificationSubject.stream.listen(
      (String payload) async {
        ...
        Get.to(DetailRestaurantPage(id: restaurant));
      },
    );
  }
}
